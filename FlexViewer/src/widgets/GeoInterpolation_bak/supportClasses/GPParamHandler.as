...
import widgets.GeoInterpolation.parameters.BaseParamParser;
import widgets.GeoInterpolation.parameters.FeatureLayerParameter;
import widgets.GeoInterpolation.parameters.GPParameterTypes;
import widgets.GeoInterpolation.parameters.IGPFeatureParameter;
import widgets.GeoInterpolation.parameters.IGPParameter;
import widgets.GeoInterpolation.parameters.InputParamParser;
import widgets.GeoInterpolation.parameters.OutputParamParser;
import widgets.Geoprocessing.parameters.RecordSetParameter;
...
public class GPParamHandler
{
	...
	public function addOutPutField(columnName:String,columnLabel:String):void
	{
		
		var recordSetParam:RecordSetParameter = findOutputParamByName("CrossValidationOutput_View") as RecordSetParameter;
		if(recordSetParam)
			recordSetParam.fields.addItem({"name":columnName,"label":columnLabel});
	}
}
}
