...
//				var value2:Number = attributeKeyValuePair["tu_hg"];
//				var value3:Number = attributeKeyValuePair["tu_as"];
				...
				for(var index=0;index<mediaInfo.chartFields.length;index++){
					chartData[mediaInfo.chartFields[index]]=attributeKeyValuePair[""+mediaInfo.chartFields[index]];//字段 对于 值
				}
